...
class OnHoverTextForHeader extends StatefulWidget {
  final Widget Function(bool isHoverd)builder;
   OnHoverTextForHeader({required this.builder, super.key});

  @override
  State<OnHoverTextForHeader> createState() => _OnHoverTextForHeaderState();
}

class _OnHoverTextForHeaderState extends State<OnHoverTextForHeader> {
  bool isHoverd = false;
  @override
  Widget build(BuildContext context) {
    // final hoveredTransform = Matrix4.identity()
